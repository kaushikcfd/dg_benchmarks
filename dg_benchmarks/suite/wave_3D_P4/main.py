...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 10799 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(10800, 15)),
    ...
    _pt_t_unit_0 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 10799 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 162000, in_2[_0, _1] % 35]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(10800, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(162000, 35)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(10800, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(10800, 15)),
        ],
    )
    _pt_t_unit_1 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(10800, 15)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(10800, 15)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(10800, 1)),
        ],
    )
    _pt_t_unit_10 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 647999 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 637200, in_2[_0, _1] % 15]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(648000, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(637200, 15)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(648000, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(648000, 15)),
        ],
    )
    _pt_t_unit_2 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[0, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(648000, 15)),
    ...
    _pt_t_unit_3 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 647999 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 10800, in_2[_0, _1] % 15]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(648000, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(10800, 15)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(648000, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(648000, 15)),
        ],
    )
    _pt_t_unit_4 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.float64, shape=(648000, 15)),
        ],
    )
    _pt_t_unit_5 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 637199 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(637200, 15)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(4, 15)),
    ...
    _pt_t_unit_6 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 162000, in_2[_0, _1] % 35]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(637200, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(162000, 35)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(637200, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(637200, 15)),
        ],
    )
    ...
    _pt_t_unit_9 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(637200, 15)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(637200, 15)),
    ...
    _pt_tmp_8 = actx.np.reshape(_pt_tmp_9, (4, 162000, 15))
    ...
    _pt_tmp_91 = actx.np.reshape(_pt_tmp_92, (4, 162000, 15))
    ...
    _pt_tmp_135 = actx.np.reshape(_pt_tmp_136, (4, 162000, 15))
    ...
    _pt_tmp_157 = actx.np.reshape(_pt_tmp_158, (4, 162000, 15))
